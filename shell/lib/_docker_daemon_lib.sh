...
readonly DOCKER_DAEMON_CONFIG_DIRECTORY_PATH="${REPO_DIR}/docker"
readonly DOCKER_DAEMON_CUSTOM_CONFIG_DIRECTORY_PATH="${REPO_DIR}/docker/${PROJECT_NAME}"
readonly DOCKER_DAEMON_CUSTOM_BASE_CONFIG_DIRECTORY_PATH="${REPO_DIR}/docker/${PROJECT_BASE_NAME}"
